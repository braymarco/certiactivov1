                                                        ...
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                            ...
                                                            <div class="space-y-3">
                                                                ...
                                                                <p class="text-gray-700"
                                                                   ...
                                                                   align="left">
                                                                    Gracias por elegirnos. Adjunto encontrarás el enlace a un formulario para completar con tus datos y documentación necesaria.
                                                                </p>
                                                                ...
                                                                <p class="text-gray-700"
                                                                   ...
                                                                   align="left">
                                                                    Link:
                                                                    <a href="{{$purchaseToken->linkCliente()}}" targe="_blank"
                                                                       style="color: #0d6efd;">{{$purchaseToken->linkCliente()}}</a>
                                                                </p>
                                                            </div>
                                                            <table class="s-5 w-full" role="presentation" border="0"
                                                                   cellpadding="0" cellspacing="0" style="width: 100%;"
