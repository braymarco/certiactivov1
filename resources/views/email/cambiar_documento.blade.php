                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                            <div class="text-center" style="" align="center">
                                                                <div class="text-center" style="" align="center">
                                                                    <img src="{{asset('logo.png')}}"
                                                                         style="max-height: 40px; max-width: 40px; height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; border-style: none; border-width: 0;">
                                                                </div>
                                                                <h1 class="h3"
                                                                    style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;"
                                                                    align="left">Firma Electr&#243;nica Certiactivo -
                                                                    Observaci&#243;n</h1>
                                                            ...
                                                            <div class="space-y-3">
                                                                ...
                                                                <table class="s-3 w-full" role="presentation" border="0"
                                                                       cellpadding="0" cellspacing="0"
                                                                       style="width: 100%;" width="100%">
                                                                    <tbody>
                                                                    <tr>
                                                                ...
                                                                <p class="text-gray-700"
                                                                   style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"
                                                                   align="left">
                                                                    La solicitud de {{$solicitud->fullName()}}
                                                                    dentificaci&#243;n {{$solicitud->nro_documento}},
                                                                    requiere el cambio de uno de los documentos de su
                                                                    solicitud detallado a continuaci&#243;n. Una vez
                                                                    modificado se realizar&#225; la verificaci&#243;n y
                                                                    posterior aprobaci&#243;n de su certificado de firma
                                                                    electr&#243;nica.
                                                                </p>
                                                                <table class="s-3 w-full" role="presentation" border="0"
                                                                       cellpadding="0" cellspacing="0"
                                                                ...
                                                                <p class="text-gray-700"
                                                                   style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"
                                                                   align="left">
                                                                    Para actualizar su documento ingrese al siguiente
                                                                    link:
                                                                    <a href="{{$docUp->linkUpdate()}}" targe="_blank"
                                                                       style="color: #0d6efd;">{{$docUp->linkUpdate()}}</a>
                                                                </p>
                                                            </div>
                                                            <table class="s-5 w-full" role="presentation" border="0"
                                                                   cellpadding="0" cellspacing="0" style="width: 100%;"
                                                            ...
                                                            <table class="btn btn-primary" role="presentation"
                                                                ...
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;"
                                                                        ...
                                                                        <a href="{{$docUp->linkUpdate()}}" target="_blank" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;">Actualizar Documento</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
